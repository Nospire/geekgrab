...
RUN pip install --no-cache-dir -r requirements.txt && ln -sf $(python3 -c "import certifi; print(certifi.where())") $(python3 -c "import curl_cffi; import os; print(os.path.dirname(curl_cffi.__file__))")/cacert.pem
